...
void Game::init(void)
{
    ...
    fullscreen = false; // true; //Assumed true at first unless overwritten at
                        // some point!
    stretchMode = 0;
...
void Game::clearcustomlevelstats()
{
    ...
    customlevelstatsloaded =
        false; // To ensure we don't load it where it isn't needed
}
...
void Game::loadcustomlevelstats()
{
    ...
    for (pElem = hRoot.FirstChildElement("Data").FirstChild().ToElement();
        ...
        if (pKey == "stats") {
            for (tinyxml2::XMLElement* stat_el = pElem->FirstChildElement();
                 stat_el;
                 stat_el = stat_el->NextSiblingElement()) {
    ...
    // If the two arrays happen to differ in length, just go with the smallest
    // one
    for (size_t i = 0;
         i < std::min(customlevelnames.size(), customlevelscores.size());
         i++) {
    ...
    if (statedelay <= 0) {
        switch (state) {
            ...
            case 5:
                ...
                advancetext = true;
                hascontrol = false;
                /*graphics.createtextbox("   Prototype Complete    ", 50, 80,
                164, 164, 255); graphics.addline("Congrats! More Info Soon!");
            ...
            case 8:
                ...
                if (!obj.flags[13]) {
                    obj.flags[13] = true;
                    graphics.createtextbox(
                        "  Press ENTER to view map  ", -1, 155, 174, 174, 174);
            ...
            case 11:
                ...
                graphics.createtextbox(
                    "   When you're NOT standing on   ", -1, 3, 174, 174, 174);
            ...
            case 12:
                ...
                if (!obj.flags[61]) {
                    ...
                    graphics.textboxremovefast();
                    graphics.createtextbox(
                        "  You can't continue to the next   ",
                        -1,
                        8,
                        174,
                        174,
            ...
            case 14:
                ...
                if (graphics.flipmode) {
                    graphics.createtextbox(
                        " When you're standing on the ceiling, ",
                        -1,
                        3,
                        174,
                        174,
            ...
            case 17:
                ...
                graphics.createtextbox(" If you prefer, you can press UP or ",
                                       -1,
                                       195,
                                       174,
                                       174,
            ...
            case 22:
                if (!obj.flags[3]) {
                    ...
                    state = 0;
                    graphics.createtextbox(
                        "  Press ACTION to flip  ", -1, 25, 174, 174, 174);
                    graphics.textboxtimer(60);
                }
            ...
            case 50:
                music.playef(15);
                graphics.createtextbox(
                    "Help! Can anyone hear", 35, 15, 255, 134, 255);
            ...
            case 51:
                music.playef(15);
                graphics.createtextbox(
                    "Verdigris? Are you out", 30, 12, 255, 134, 255);
            ...
            case 52:
                music.playef(15);
                graphics.createtextbox(
                    "Please help us! We've crashed", 5, 22, 255, 134, 255);
            ...
            case 53:
                music.playef(15);
                graphics.createtextbox(
                    "Hello? Anyone out there?", 40, 15, 255, 134, 255);
                graphics.textboxtimer(60);
                state++;
                statedelay = 100;
                break;
            case 54:
                music.playef(15);
                graphics.createtextbox(
                    "This is Doctor Violet from the", 5, 8, 255, 134, 255);
            ...
            case 55:
                music.playef(15);
                graphics.createtextbox(
                    "Please... Anyone...", 45, 14, 255, 134, 255);
                graphics.textboxtimer(60);
                state++;
                statedelay = 100;
                break;
            case 56:
                music.playef(15);
                graphics.createtextbox(
                    "Please be alright, everyone...", 25, 18, 255, 134, 255);
                graphics.textboxtimer(60);
                state = 50;
                statedelay = 100;
                break;
            ...
            case 82:
                ...
                if (timetrialresulttime <= timetrialpar)
                    timetrialrank++;
                if (trinkets() >= timetrialshinytarget)
                    timetrialrank++;
                if (deathcounts == 0)
                    timetrialrank++;
                ...
                if (timetrialresulttime < besttimes[timetriallevel] ||
                    (timetrialresulttime == besttimes[timetriallevel] &&
                     timetrialresultframes < bestframes[timetriallevel]) ||
                    besttimes[timetriallevel] == -1) {
                    besttimes[timetriallevel] = timetrialresulttime;
                    bestframes[timetriallevel] = timetrialresultframes;
                }
                if (trinkets() > besttrinkets[timetriallevel] ||
                    besttrinkets[timetriallevel] == -1) {
                    besttrinkets[timetriallevel] = trinkets();
                }
                if (deathcounts < bestlives[timetriallevel] ||
                    bestlives[timetriallevel] == -1) {
                    bestlives[timetriallevel] = deathcounts;
                }
                if (timetrialrank > bestrank[timetriallevel] ||
                    bestrank[timetriallevel] == -1) {
            ...
            case 85:
                ...
                // From 90-100 are run scripts for the eurogamer expo only,
                // remove later
            case 90:
                // Generic "run script"
                startscript = true;
            ...
            case 102: {
                ...
                graphics.createtextbox(
                    "Captain! I've been so worried!", 60, 90, 164, 255, 164);
                state++;
                music.playef(12);
            } break;
            case 104:
                graphics.createtextbox(
                    "I'm glad you're ok!", 135, 152, 164, 164, 255);
                state++;
                music.playef(11);
            ...
            case 106: {
                graphics.createtextbox(
                    "I've been trying to find a", 74, 70, 164, 255, 164);
            ...
            case 108:
                graphics.createtextbox(
                    "Don't worry! I have a", 125, 152, 164, 164, 255);
            ...
            case 115:
                //
                //                       Test script for space station, totally
                //                       delete me!
                //
                {
                    i = obj.getplayer();
            ...
            case 116:
                ...
                graphics.createtextbox("Sorry Eurogamers! Teleporting around",
                                       60 - 20,
                                       200,
                                       255,
                                       64,
            ...
            case 122:
                ...
                graphics.createtextbox(
                    "Captain! You're ok!", 60 - 10, 90 - 40, 255, 255, 134);
                state++;
                music.playef(14);
                break;
            case 124:
                graphics.createtextbox("I've found a teleporter, but",
                                       60 - 20,
                                       90 - 40,
                                       255,
                                       255,
                ...
                graphics.textboxactive();
                i = obj.getcompanion();
                if (i > -1) { /*obj.entities[i].tile = 66;
                                 obj.entities[i].state = 0;*/
                }
                break;
            case 126:
                graphics.createtextbox(
                    "I can help with that!", 125, 152 - 40, 164, 164, 255);
                state++;
                music.playef(11);
                graphics.textboxactive();
                break;
            case 128:
                graphics.createtextbox(
                    "I have the teleporter", 130, 152 - 35, 164, 164, 255);
            ...
            case 130:
                graphics.createtextbox(
                    "Yey! Let's go home!", 60 - 30, 90 - 35, 255, 255, 134);
                state++;
                music.playef(14);
                graphics.textboxactive();
                i = obj.getcompanion();
            ...
            // WARNING: If updating this code, make sure to update Map.cpp
            // mapclass::twoframedelayfix()
            case 300:
            case 301:
            case 302:
            case 303:
            ...
            case 1001:
                ...
                state++;
                if (graphics.flipmode) {
                    graphics.createtextbox("        Congratulations!       ",
                                           50,
                                           105,
                                           174,
                                           174,
...
#endif
                    {
                        graphics.createtextbox(" " + help.number(trinkets()) +
                                                   " out of Twenty ",
                                               50,
                                               65,
                                               174,
            ...
            case 1011:
                ...
                if (graphics.flipmode) {
                    ...
                    if (ed.numcrewmates() - crewmates() == 0) {
                        ...
                        graphics.createtextbox(
                            "    " +
                                help.number(ed.numcrewmates() - crewmates()) +
                                " remains    ",
                            50,
                            65,
                            174,
            ...
            case 2000:
                ...
                if (inspecial() || map.custommode) {
                    ...
                    if (graphics.flipmode) {
                        graphics.createtextbox(
                            "    Game Saved    ", -1, 202, 174, 174, 174);
                        graphics.textboxtimer(25);
                    } else {
                        graphics.createtextbox(
                            "    Game Saved    ", -1, 12, 174, 174, 174);
                        graphics.textboxtimer(25);
                    }
                    state = 0;
                }
            ...
            case 2510:
                ...
                hascontrol = false;
                graphics.createtextbox(
                    "Hello?", 125 + 24, 152 - 20, 164, 164, 255);
                state++;
                music.playef(11);
                graphics.textboxactive();
                break;
            case 2512:
                ...
                hascontrol = false;
                graphics.createtextbox(
                    "Is anyone there?", 125 + 8, 152 - 24, 164, 164, 255);
                state++;
                music.playef(11);
                graphics.textboxactive();
                break;
            ...
            case 3006:
                ...
                /*												advancetext
                = true; hascontrol = false; state = 3;
                graphics.createtextbox("To do: write quick", 50, 80, 164, 164,
                255); graphics.addline("intro to story!");*/
                break;
            case 3007:
                state++;
                statedelay = 45;
            ...
            case 3008: {
                ...
                if (temp == 1) {
                    ...
                    if (graphics.flipmode) {
                        graphics.createtextbox(
                            tempstring, -1, 72, 174, 174, 174);
                    } else {
                        graphics.createtextbox(
                            tempstring, -1, 128 + 16, 174, 174, 174);
                    }
                } else if (temp > 0) {
                    std::string tempstring =
                        "  " + help.number(temp) + " remain  ";
                    if (graphics.flipmode) {
                        graphics.createtextbox(
                            tempstring, -1, 72, 174, 174, 174);
                    } else {
            ...
            case 3009:
                ...
                if (graphics.flipmode) {
                    graphics.createtextbox(
                        " Press ACTION to continue ", -1, 20, 164, 164, 255);
                } else {
                    graphics.createtextbox(
                        " Press ACTION to continue ", -1, 196, 164, 164, 255);
                }
                graphics.textboxcenterx();
                break;
            case 3010:
            ...
            case 3054:
                if (jumppressed) {
                    ...
                    statedelay = 30;
                    graphics.textboxremove();
                    crewstats[1] = 0; // Set violet's rescue script to 0 to make
                                      // the next bit easier
                    teleportscript = "";
                }
                break;
            ...
            case 3071:
                ...
                break;
            case 3072:
                // Ok, we need to adjust some flags based on who've we've
                // rescued. Some of there conversation options change depending
                // on when they get back to the ship.
                if (lastsaved == 2) {
                    if (crewstats[3])
                        obj.flags[25] = true;
                    if (crewstats[4])
            ...
            case 3101:
                ...
                graphics.createtextbox("   Congratulations!    ", 50, 80, 164,
                164, 255); graphics.addline(""); graphics.addline("Your play of
                this level has"); graphics.addline("been copied to the
                clipboard."); graphics.addline(""); graphics.addline("Please
                consider pasting and"); graphics.addline("sending it to me! Even
                if you"); graphics.addline("made a lot of mistakes - knowing");
            ...
            case 3502:
                ...
                if (graphics.flipmode) {
                    graphics.createtextbox(
                        "  All Crew Members Rescued!  ", -1, 175 - 24, 0, 0, 0);
                } else {
                    graphics.createtextbox(
            ...
            case 3503: {
                ...
                if (graphics.flipmode) {
                    graphics.createtextbox(
                        "Trinkets Found:", 48, 155 - 24, 0, 0, 0);
            ...
            case 3505:
                ...
                if (graphics.flipmode) {
                    graphics.createtextbox(
                        " Total Flips:", 64, 116 - 24, 0, 0, 0);
                    graphics.createtextbox(
                        help.String(totalflips), 180, 116 - 24, 0, 0, 0);
                } else {
                    graphics.createtextbox(" Total Flips:", 64, 123, 0, 0, 0);
                    graphics.createtextbox(
                        help.String(totalflips), 180, 123, 0, 0, 0);
                }
                break;
            case 3506:
                state++;
                ...
                if (graphics.flipmode) {
                    graphics.createtextbox(
                        "Total Deaths:", 64, 104 - 24, 0, 0, 0);
                    graphics.createtextbox(
                        help.String(deathcounts), 180, 104 - 24, 0, 0, 0);
                } else {
                    graphics.createtextbox("Total Deaths:", 64, 135, 0, 0, 0);
                    graphics.createtextbox(
                        help.String(deathcounts), 180, 135, 0, 0, 0);
                }
                break;
            case 3507: {
                state++;
                ...
                if (graphics.flipmode) {
                    std::string tempstring = "Hardest Room (with " +
                                             help.String(hardestroomdeaths) +
                                             " deaths)";
            ...
            case 4070:
                // Activating a teleporter (special for final script, player has
                // colour changed to match rescued crewmate)
                state++;
                statedelay = 15;
                flashlight = 5;
                screenshake = 90;
...
void Game::gethardestroom()
{
    if (currentroomdeaths > hardestroomdeaths) {
        ...
        if (map.roomname == "glitch") {
            ...
            if (roomx == 45 && roomy == 51)
                hardestroom = map.specialnames[3];
            if (roomx == 46 && roomy == 51)
                hardestroom = map.specialnames[4];
            if (roomx == 47 && roomy == 51)
                hardestroom = map.specialnames[5];
            if (roomx == 50 && roomy == 53)
                hardestroom = map.specialnames[6];
            if (roomx == 50 && roomy == 54)
                hardestroom = map.specialnames[7];
...
#define LOAD_ARRAY_RENAME(ARRAY_NAME, DEST)                                    \
    if (pKey == #ARRAY_NAME) {                                                 \
        ...
        if (TextString.length()) {                                             \
            std::vector<std::string> values = split(TextString, ',');          \
            for (size_t i = 0;                                                 \
                 i < SDL_min(SDL_arraysize(DEST), values.size());              \
                 i++) {                                                        \
...
void Game::savestats()
{
    ...
    msg->LinkEndChild(
        doc.NewText(help.String(fullScreenEffect_badSignal).c_str()));
    dataNode->LinkEndChild(msg);
    ...
    msg->LinkEndChild(
        doc.NewText(help.String((int)graphics.notextoutline).c_str()));
    dataNode->LinkEndChild(msg);

    msg = doc.NewElement("translucentroomname");
    msg->LinkEndChild(
        doc.NewText(help.String((int)graphics.translucentroomname).c_str()));
    dataNode->LinkEndChild(msg);

    msg = doc.NewElement("showmousecursor");
    msg->LinkEndChild(
        doc.NewText(help.String((int)graphics.showmousecursor).c_str()));
    dataNode->LinkEndChild(msg);
...
void Game::customstart()
{
    ...
    // savex = 6 * 8; savey = 15 * 8; saverx = 46; savery = 54; savegc = 0;
    // savedir = 1; //Final Level Current
    savepoint = 0;
    gravitycontrol = savegc;

    // state = 2; deathseq = -1; lifeseq = 10; //Not dead, in game initilisation
    // state
    state = 0;
    deathseq = -1;
    lifeseq = 0;
...
void Game::deathsequence()
{
    ...
    if (deathseq == 30) {
        ...
        if (map.finalmode) {
            if (roomx - 41 >= 0 && roomx - 41 < 20 && roomy - 48 >= 0 &&
                roomy - 48 < 20) {
            ...
            if (roomx - 100 >= 0 && roomx - 100 < 20 && roomy - 100 >= 0 &&
                roomy - 100 < 20) {
...
void Game::customloadquick(std::string savfile)
{
    ...
    tinyxml2::XMLDocument doc;
    if (!FILESYSTEM_loadTiXml2Document(("saves/" + levelfile + ".vvv").c_str(),
                                       doc))
        return;
...
void Game::initteleportermode()
{
    ...
    for (size_t i = 0; i < map.teleporters.size(); i++) {
        if (roomx == map.teleporters[i].x + 100 &&
            roomy == map.teleporters[i].y + 100) {
...
void Game::customsavequick(std::string savfile)
{
    ...
    std::string levelfile = savfile.substr(7);
    if (FILESYSTEM_saveTiXml2Document(("saves/" + levelfile + ".vvv").c_str(),
                                      doc)) {
        printf("Game saved\n");
    } else {
        printf("Could Not Save game!\n");
...
std::string Game::partimestring()
{
    ...
    if (timetrialpar >= 60) {
        tempstring =
            help.twodigits(int((timetrialpar - (timetrialpar % 60)) / 60)) +
            ":" + help.twodigits(timetrialpar % 60);
    } else {
...
std::string Game::resulttimestring()
{
    ...
    if (timetrialresulttime >= 60) {
        tempstring =
            help.twodigits(
                int((timetrialresulttime - (timetrialresulttime % 60)) / 60)) +
...
std::string Game::timetstring(int t)
{
    ...
    std::string tempstring = "";
    if (t >= 60) {
        tempstring = help.twodigits(int((t - (t % 60)) / 60)) + ":" +
                     help.twodigits(t % 60);
    } else {
...
void Game::returnmenu()
{
    ...
    menu_.cur_option_idx = previousoption;
...
{
    if (menu_.cur_option_name == t) {
        // Re-create the menu
        int keep_menu_option = menu_.cur_option_idx;
        createmenu(t, true);
        if (keep_menu_option < (int)menu_.options.size()) {
            menu_.cur_option_idx = keep_menu_option;
        }
        return;
    }
...
void Game::createmenu(enum Menu::name t, bool samemenu /*= false*/)
{
    if (t == Menu::mainmenu) {
        ...
        frame.option = menu_.cur_option_idx;
        frame.name = menu_.cur_option_name;
        menustack.push_back(frame);
    }

    menu_.cur_option_idx = 0;
    menu_.cur_option_name = t;
    menu_.yoff = 0;
    int maxspacing =
        30; // maximum value for menu_.spacing, can only become lower.
    menu_.countdown = 0;
    menu_.options.clear();
    ...
    switch (t) {
            ...
            if (ed.ListOfMetaData.size() == 0) {
                     ...
                     i++) // FIXME: int/size_t! -flibit
                {
                    if (i >= levelpage * 8 && i < (levelpage * 8) + 8) {
                        // This is, er, suboptimal. Whatever, life optimisation
                        // and all that
                        int tvar = -1;
                        for (size_t j = 0; j < customlevelstats.size(); j++) {
                            if (ed.ListOfMetaData[i].filename.substr(7) ==
                                customlevelstats[j].name) {
                                tvar = j;
                                break;
                            }
                        }
                        ...
                        SDL_snprintf(text,
                                     ...
                                     "%s%s",
                                     prefix,
                                     ed.ListOfMetaData[i].title.c_str());
                ...
                menu_.xoff = 20;
                menu_.yoff = 70 - (menu_.options.size() * 10);
                menu_.spacing = 5;
        ...
        case Menu::play: {
            ...
            int temp = 0;
            if (unlock[0] && stat_trinkets >= 3 && !unlocknotify[9])
                temp++;
            if (unlock[1] && stat_trinkets >= 6 && !unlocknotify[10])
                temp++;
            if (unlock[2] && stat_trinkets >= 9 && !unlocknotify[11])
                temp++;
            if (unlock[3] && stat_trinkets >= 12 && !unlocknotify[12])
                temp++;
            if (unlock[4] && stat_trinkets >= 15 && !unlocknotify[13])
                temp++;
            if (unlock[5] && stat_trinkets >= 18 && !unlocknotify[14])
                temp++;
            if (temp > 0) {
                ...
                // Alright, we haven't unlocked any time trials. How about no
                // death mode?
                temp = 0;
                if (bestrank[0] >= 2)
                    temp++;
    ...
    // Automatically center the menu. We must check the width of the menu with
    // the initial horizontal spacing. If it's too wide, reduce the horizontal
    // spacing by 5 and retry. Try to limit the menu width to 272 pixels: 320
    // minus 16*2 for square brackets, minus 8*2 padding. The square brackets
    // fall outside the menu width (i.e. selected menu options are printed 16
    // pixels to the left)
    bool done_once = false;
    int menuwidth = 0;
    for (; !done_once || (menuwidth > 272 && menu_.spacing > 0);
         maxspacing -= 5) {
        done_once = true;
        menu_.spacing = maxspacing;
        menuwidth = 0;
        for (size_t i = 0; i < menu_.options.size(); i++) {
            int width = i * menu_.spacing + graphics.len(menu_.options[i].text);
            if (width > menuwidth)
                menuwidth = width;
        }
    }
    menu_.xoff = (320 - menuwidth) / 2;
}
