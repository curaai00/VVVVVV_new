...
public:
    ...
    void reset();
    void getlin(const enum textmode mode,
    ...
    int warpzoneedgetile(
        int x,
        int y,
        int (editorclass::*match_func)(int, int) = &editorclass::backmatch);
    ...
    static const int maxwidth = 20,
                     maxheight =
                         20; // Special; the physical max the engine allows
