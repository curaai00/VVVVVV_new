...
int pre_darkcol = 0, pre_lightcol = 0, pre_curcol = 0, pre_coltimer = 0,
    pre_offset = 0;

int pre_frontrectx = 30, pre_frontrecty = 20, pre_frontrectw = 260,
    pre_frontrecth = 200;
int pre_temprectx = 0, pre_temprecty = 0, pre_temprectw = 320,
    pre_temprecth = 240;
...
void preloaderrender()
{
    if (pre_transition >= 30) {
        ...
        FillRect(graphics.backBuffer,
                 ...
                 pre_frontrectw,
                 pre_frontrecth,
                 graphics.getBGR(0x3E, 0x31, 0xA2));

        if (pre_fakepercent == 100) {
            graphics.Print(282 - (15 * 8),
                           204,
                           "LOADING... " + help.String(int(pre_fakepercent)) +
                               "%",
                           124,
                           112,
                           218,
        ...
        graphics.Print(
            282 - (15 * 8), 204, "LOADING... 100%", 124, 112, 218, false);
    }
