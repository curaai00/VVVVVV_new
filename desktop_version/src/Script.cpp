    ...
    while (running && scriptdelay <= 0 && !game.pausescript) {
        if (position < (int)commands.size()) {
            ...
            if (words[0] == "warpdir") {
                ...
                if (inbounds && game.roomx - 100 == temprx &&
                    game.roomy - 100 == tempry) {
            ...
            if (words[0] == "ifwarp") {
                int room = ss_toi(words[1]) - 1 +
                           (ed.maxwidth * (ss_toi(words[2]) - 1));
                if (room >= 0 && room < 400 &&
                    ed.level[room].warpdir == ss_toi(words[3])) {
            ...
            if (words[0] == "untilbars") {
                ...
                if (i > -1 && words[2] == "above") {
                    if (j == 1) // left
                    {
                        textx = obj.entities[i].xp -
                                10000; // tells the box to be oriented correctly
                                       // later
                ...
                // If using "speak", don't make the textbox active (so we can
                // use multiple textboxes)
                if (txt.empty()) {
                    txt.resize(1);
                }
                ...
                if (words[9] == "")
                    words[9] = "240";
                obj.createentity(ss_toi(words[1]),
                                 ss_toi(words[2]),
                                 ss_toi(words[3]),
                                 ss_toi(words[4]),
                                 ss_toi(words[5]),
                ...
                if (words[5] == "followplayer")
                    words[5] = "10";
                if (words[5] == "followpurple")
                    words[5] = "11";
                if (words[5] == "followyellow")
                    words[5] = "12";
                if (words[5] == "followred")
                    words[5] = "13";
                if (words[5] == "followgreen")
                    words[5] = "14";
                if (words[5] == "followblue")
                    words[5] = "15";

                if (words[5] == "followposition")
                    words[5] = "16";
                if (words[5] == "faceleft") {
                    words[5] = "17";
                    words[6] = "0";
                ...
                if (words[2] == "followplayer")
                    words[2] = "10";
                if (words[2] == "followpurple")
                    words[2] = "11";
                if (words[2] == "followyellow")
                    words[2] = "12";
                if (words[2] == "followred")
                    words[2] = "13";
                if (words[2] == "followgreen")
                    words[2] = "14";
                if (words[2] == "followblue")
                    words[2] = "15";

                if (words[2] == "followposition")
                    words[2] = "16";
                if (words[2] == "faceleft") {
                    words[2] = "17";
                    words[3] = "0";
                ...
                if (crewmate < SDL_arraysize(game.crewstats) &&
                    game.crewstats[crewmate] == false) {
                    load(words[2]);
                    position--;
                }
                ...
                if (i == 4) {
                    obj.createblock(5,
                                    obj.entities[obj.getcrewman(i)].xp - 32,
                                    obj.entities[obj.getcrewman(i)].yp - 20,
                                    96,
                                    60,
                                    i);
                } else {
                ...
                graphics.createtextbox(
                    "        Congratulations!       ", 50, 85, 174, 174, 174);
                graphics.addline("");
                ...
                graphics.createtextbox(
                    "The secret lab is separate from", 50, 85, 174, 174, 174);
...
void scriptclass::startgamemode(int t)
{
    switch (t) {
        ...
        case 3:
            ...
            if (graphics.setflipmode)
                graphics.flipmode = true; // set flipmode
            if (obj.entities.empty()) {
                obj.createentity(game.savex,
                                 game.savey,
                                 0,
        ...
        case 22: // play custom level (in game)
        {
            ...
            std::string filename =
                std::string(ed.ListOfMetaData[game.playcustomlevel].filename);
            ed.load(filename);
            ed.findstartpoint();
...
void scriptclass::teleport()
{
    ...
    i = obj.getplayer(); // less likely to have a serious collision error if the
                         // player is centered
    if (i > -1) {
...
void scriptclass::hardreset()
{
    ...
    if (!game.glitchrunnermode) {
        ...
        // in glitchrunnermode even more glitchy
        game.roomx = 0;
        game.roomy = 0;
    }
    game.prevroomx = 0;
    ...
    i = 100; // previously a for-loop iterating over collect/customcollect set
             // this to 100
...
{
    // this magic function breaks down the custom script and turns into real
    // scripting!
    ...
    // Ok, we've got the relavent script segment, we do a pass to assess it,
    // then run it!
    ...
    for (size_t i = 0; i < lines.size(); i++) {
        ...
        if (words[0] == "music") {
            ...
            } else if (words[1] == "cyan" || words[1] == "viridian" ||
                       words[1] == "1") {
                add("changecustommood(customcyan,1)");
            } else if (words[1] == "purple" || words[1] == "violet" ||
                       words[1] == "pink" || words[1] == "2") {
                add("changecustommood(purple,1)");
            } else if (words[1] == "yellow" || words[1] == "vitellary" ||
                       words[1] == "3") {
                add("changecustommood(yellow,1)");
            } else if (words[1] == "red" || words[1] == "vermilion" ||
                       words[1] == "4") {
                add("changecustommood(red,1)");
            } else if (words[1] == "green" || words[1] == "verdigris" ||
                       words[1] == "5") {
                add("changecustommood(green,1)");
            } else if (words[1] == "blue" || words[1] == "victoria" ||
                       words[1] == "6") {
                add("changecustommood(blue,1)");
            } else if (words[1] == "all" || words[1] == "everybody" ||
                       words[1] == "everyone") {
                add("changemood(player,1)");
                add("changecustommood(customcyan,1)");
                add("changecustommood(purple,1)");
            ...
            speakermode = 0;
            if (words[1] == "gray" || words[1] == "grey" ||
                words[1] == "terminal" || words[1] == "0")
                speakermode = 0;
            if (words[1] == "cyan" || words[1] == "viridian" ||
                words[1] == "player" || words[1] == "1")
                speakermode = 1;
            if (words[1] == "purple" || words[1] == "violet" ||
                words[1] == "pink" || words[1] == "2")
                speakermode = 2;
            if (words[1] == "yellow" || words[1] == "vitellary" ||
                words[1] == "3")
                speakermode = 3;
            if (words[1] == "red" || words[1] == "vermilion" || words[1] == "4")
                speakermode = 4;
            if (words[1] == "green" || words[1] == "verdigris" ||
                words[1] == "5")
                speakermode = 5;
            ...
            // Speakers!
            if (words[2] == "terminal" || words[2] == "gray" ||
                words[2] == "grey" || words[2] == "0")
                speakermode = 0;
            if (words[2] == "cyan" || words[2] == "viridian" ||
                words[2] == "player" || words[2] == "1")
                speakermode = 1;
            if (words[2] == "purple" || words[2] == "violet" ||
                words[2] == "pink" || words[2] == "2")
                speakermode = 2;
            if (words[2] == "yellow" || words[2] == "vitellary" ||
                words[2] == "3")
                speakermode = 3;
            if (words[2] == "red" || words[2] == "vermilion" || words[2] == "4")
                speakermode = 4;
            if (words[2] == "green" || words[2] == "verdigris" ||
                words[2] == "5")
                speakermode = 5;
