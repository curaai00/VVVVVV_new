...
void menurender()
{
    ...
    switch (game.menu_.cur_option_name) {
        case Menu::mainmenu:
            ...
            if (music.mmmmmm) {
                graphics.Print(
                    10, 230, "[MMMMMM Mod Installed]", tr / 2, tg / 2, tb / 2);
            }
            break;
        ...
        case Menu::levellist: {
            ...
            if (tmp >= 0 && tmp < (int)ed.ListOfMetaData
                ...
                if (game.menu_.options.size() - game.menu_.cur_option_idx <=
                    ...
                    graphics.bigprint(
                        -1, 15, ed.ListOfMetaData[tmp].title, tr, tg, tb, true);
                    graphics.Print(-1,
                                   40,
                    ...
                    graphics.Print(-1,
                                   ...
                                   true);
                    graphics.Print(
                        -1, 70, ed.ListOfMetaData[tmp].Desc1, tr, tg, tb, true);
                    graphics.Print(
                        -1, 80, ed.ListOfMetaData[tmp].Desc2, tr, tg, tb, true);
                    graphics.Print(
                        -1, 90, ed.ListOfMetaData[tmp].Desc3, tr, tg, tb, true);
                }
            }
            break;
        }
        ...
        case Menu::options: {
            ...
            if (game.menu_.cur_option_idx == 4 + offset) {
                ...
                if (music.usingmmmmmm) {
                    graphics.Print(
                        -1, 85, "Current soundtrack: MMMMMM", tr, tg, tb, true);
                } else {
                    graphics.Print(
                        -1, 85, "Current soundtrack: PPPPPP", tr, tg, tb, true);
                }
                break;
            }
            break;
            ...
            switch (game.menu_.cur_option_idx) {
                case 0:
                    ...
                    if (game.fullscreen) {
                        ...
                        graphics.Print(
                            -1, 85, "Current mode: WINDOWED", tr, tg, tb, true);
                    }
                    break;
                ...
                case 1:
                    ...
                    if (game.stretchMode == 2) {
                        graphics.Print(
                            -1, 85, "Current mode: INTEGER", tr, tg, tb, true);
                    } else if (game.stretchMode == 1) {
                        graphics.Print(
                            -1, 85, "Current mode: STRETCH", tr, tg, tb, true);
                    } else {
                        graphics.Print(-1,
                                       85,
                ...
                case 2:
                    ...
                    if (!graphics.screenbuffer->isWindowed) {
                        graphics.Print(-1,
                                       ...
                                       true);
                        graphics.Print(
                            -1, 105, "to use this option.", tr, tg, tb, true);
                    }
                    break;
                case 3:
                    graphics.bigprint(
                    ...
                    if (game.useLinearFilter) {
                        graphics.Print(
                            -1, 85, "Current mode: LINEAR", tr, tg, tb, true);
                    } else {
                        graphics.Print(
                            -1, 85, "Current mode: NEAREST", tr, tg, tb, true);
                    }
                    break;
                ...
                case 5:
                    ...
                    graphics.Print(
                        -1, 65, "Change whether the game", tr, tg, tb, true);
                    graphics.Print(
                        -1, 75, "runs at 30 or over 30 FPS.", tr, tg, tb, true);
                ...
                case 6:
                    ...
                    if (!graphics.screenbuffer->vsync) {
                        ...
                        graphics.Print(
                            -1, 95, "Current mode: VSYNC ON", tr, tg, tb, true);
                    }
                    break;
            }
            break;
        ...
        case Menu::credits4: {
            ...
            int startidx = game.current_credits_list_index;
            int endidx =
                std::min(startidx + 14, (int)SDL_arraysize(Credits::patrons));
        ...
        case Menu::credits6:
            ...
            graphics.Print(
                80, 100, "Your support makes it possible", tr, tg, tb, true);
            graphics.Print(
                80, 110, "for me to continue making the", tr, tg, tb, true);
            graphics.Print(
                80, 120, "games I want to make, now", tr, tg, tb, true);
            ...
            switch (game.menu_.cur_option_idx) {
                case 0:
                    ...
                    if (graphics.showmousecursor) {
                        graphics.Print(
                            -1, 95, "Current mode: SHOW", tr, tg, tb, true);
                    } else {
                        graphics.Print(-1,
                                       95,
                                       "Current mode: HIDE",
                ...
                case 1:
                    graphics.bigprint(
                        -1, 30, "Unfocus Pause", tr, tg, tb, true);
                    graphics.Print(-1,
                                   65,
                                   "Toggle if the game will pause",
                                   tr,
                                   tg,
                                   tb,
                                   true);
                    ...
                    if (game.disablepause) {
                        ...
                        graphics.Print(
                            -1, 95, "Unfocus pause is ON", tr, tg, tb, true);
                    }
                    break;
                case 2:
                    graphics.bigprint(
                        -1, 30, "Fake Load Screen", tr, tg, tb, true);
                    if (game.skipfakeload)
                        graphics.Print(-1,
                                       65,
                                       "Fake loading screen is OFF",
                                       tr / 2,
                                       tg / 2,
                                       tb / 2,
                                       true);
                ...
                case 3:
                    ...
                    graphics.Print(-1,
                                   65,
                                   "Lets you see through what is behind",
                                   tr,
                                   tg,
                                   tb,
                                   true);
                    ...
                    if (graphics.translucentroomname)
                        graphics.Print(-1,
                                       95,
                                       "Room name background is TRANSLUCENT",
                                       tr / 2,
                                       tg / 2,
                                       tb / 2,
                                       true);
                        ...
                        graphics.Print(-1,
                                       95,
                                       "Room name background is OPAQUE",
                                       tr,
                                       tg,
                                       tb,
                                       true);
                ...
                case 4:
                    graphics.bigprint(
                        -1, 30, "Glitchrunner Mode", tr, tg, tb, true);
                    graphics.Print(-1,
                                   65,
                                   "Re-enable glitches that existed",
                                   tr,
                                   tg,
                                   tb,
                                   true);
            ...
            switch (game.menu_.cur_option_idx) {
                case 0:
                    ...
                    if (!game.colourblindmode) {
                        graphics.Print(
                            -1, 75, "Backgrounds are ON.", tr, tg, tb, true);
                    } else {
                        graphics.Print(-1,
                                       75,
                                       "Backgrounds are OFF.",
                ...
                case 1:
                    ...
                    if (!game.noflashingmode) {
                        graphics.Print(
                            -1, 85, "Screen Effects are ON.", tr, tg, tb, true);
                    } else {
                        graphics.Print(-1,
                                       85,
                ...
                case 2:
                    ...
                    if (!graphics.notextoutline) {
                        graphics.Print(
                            -1, 85, "Text outlines are ON.", tr, tg, tb, true);
                    } else {
                        graphics.Print(-1,
                                       85,
                ...
                case 3:
                    ...
                    if (map.invincibility) {
                        graphics.Print(
                            -1, 105, "Invincibility is ON.", tr, tg, tb, true);
                    } else {
                        graphics.Print(-1,
                                       105,
                ...
                case 4:
                    ...
                    graphics.Print(-1,
                                   ...
                                   true);
                    graphics.Print(
                        -1, 85, "using one switch devices.", tr, tg, tb, true);
        ...
        case Menu::gameover2: {
            ...
            for (int i = 0; i < 6; i++) {
                graphics.drawcrewman(
                    169 - (3 * 42) + (i * 42), 68, i, game.crewstats[i], true);
            }
            std::string tempstring;
            tempstring = "You rescued " + help.number(game.crewrescued()) +
                         (game.crewrescued() == 1 ? " crewmate" : " crewmates");
            graphics.Print(0, 100, tempstring, tr, tg, tb, true);

            tempstring = "and found " + help.number(game.trinkets()) +
        ...
        case Menu::nodeathmodecomplete2: {
            ...
            tempstring =
                "And you found " + help.number(game.trinkets()) + " trinkets.";
            graphics.Print(0, 110, tempstring, tr, tg, tb, true);

            graphics.Print(
                0, 160, "A new trophy has been awarded and", tr, tg, tb, true);
            graphics.Print(
        ...
        case Menu::timetrialcomplete3: {
            ...
            std::string tempstring =
                game.resulttimestring() + " / " + game.partimestring() + ".99";
                ...
                case 0:
                    if (game.unlock[9]) {
                        ...
                        if (game.besttimes[0] == -1) {
                            graphics.Print(
                                -1, 75, "Not yet attempted", tr, tg, tb, true);
                        } else {
                            ...
                            graphics.Print(110,
                                           75,
                                           help.String(game.besttrinkets[0]) +
                                               "/2",
                                           tr,
                                           tg,
                                           tb);
                        ...
                        graphics.Print(
                            -1, 85, "Find three trinkets", tr, tg, tb, true);
                    }
                    break;
                case 1:
                    if (game.unlock[10]) {
                        ...
                        if (game.besttimes[1] == -1) {
                            ...
                            graphics.Print(110,
                                           75,
                                           help.String(game.besttrinkets[1]) +
                                               "/4",
                                           tr,
                                           tg,
                                           tb);
                ...
                case 2:
                    if (game.unlock[11]) {
                        ...
                        if (game.besttimes[2] == -1) {
                            ...
                            graphics.Print(110,
                                           75,
                                           help.String(game.besttrinkets[2]) +
                                               "/2",
                                           tr,
                                           tg,
                                           tb);
                ...
                case 3:
                    if (game.unlock[12]) {
                        ...
                        if (game.besttimes[3] == -1) {
                            ...
                            graphics.Print(110,
                                           75,
                                           help.String(game.besttrinkets[3]) +
                                               "/5",
                                           tr,
                                           tg,
                                           tb);
                        ...
                        graphics.Print(
                            -1, 85, "Find twelve trinkets", tr, tg, tb, true);
                    }
                    break;
                case 4:
                    if (game.unlock[13]) {
                        ...
                        if (game.besttimes[4] == -1) {
                            ...
                            graphics.Print(110,
                                           75,
                                           help.String(game.besttrinkets[4]) +
                                               "/1",
                                           tr,
                                           tg,
                                           tb);
                        ...
                        graphics.Print(
                            -1, 85, "Find fifteen trinkets", tr, tg, tb, true);
                    }
                    break;
                case 5:
                    if (game.unlock[14]) {
                        ...
                        if (game.besttimes[5] == -1) {
                            ...
                            graphics.Print(110,
                                           75,
                                           help.String(game.besttrinkets[5]) +
                                               "/1",
                                           tr,
                                           tg,
                                           tb);
                        ...
                        graphics.Print(
                            -1, 85, "Find eighteen trinkets", tr, tg, tb, true);
                    }
                    break;
            }
            break;
        ...
        case Menu::playerworlds: {
            ...
            if (tempstring.length() > 80) {
                ...
                graphics.Print(-1,
                               ...
                               tb,
                               true);
                graphics.Print(320 - ((tempstring.length() - 80) * 8),
                               190,
                ...
                graphics.Print(-1,
                               ...
                               tb,
                               true);
                graphics.Print(320 - ((tempstring.length() - 40) * 8),
                               200,
