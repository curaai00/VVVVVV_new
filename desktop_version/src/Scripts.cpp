...
void scriptclass::load(const std::string& name)
{
    ...
    if (strcmp(customstring, "custom_") == 0) {
        ...
        // Finally, appear at the start of the game:
        static const char* lines[] = {
            "gotoroom(13,5)",  "gotoposition(80,96,0)", "walk(right,17)",
            "fadein()",

            "setcheckpoint()",

            "play(1)",         "endcutscene()",         "untilbars()",
    ...
    if (SDL_strcmp(t, "communicationstation") == 0) {
        ...
        static const char* lines[] = {
            "nocontrol()", "createcrewman(230,153,purple,0,faceleft)",

            "cutscene()",  "untilbars()",

            "delay(30)",   "rescued(purple)",

            "delay(10)",   "gamestate(4090)",
        };
        filllines(lines);
    } else if (SDL_strcmp(t, "levelonecomplete_ending") == 0) {
        static const char* lines[] = {
            "squeak(purple)",  "text(purple,0,0,1)",
            "Captain!",        "position(purple,above)",
            "speak_active",    "endtext",
            "nocontrol()",
        ...
        static const char* lines[] = {
            "changeai(green,followplayer)", "squeak(green)", "rescued(green)",
            "changemood(green,0)",          "companion(6)",
        };
        filllines(lines);
        ...
        static const char* lines[] = {
            "changeai(red,followplayer)", "squeak(red)",  "rescued(red)",
            "changemood(red,0)",          "companion(9)",
        };
        filllines(lines);
        ...
        static const char* lines[] = {
            ...
            "gotoroom(4,10)",  "gotoposition(232,113,0)",
            "setcheckpoint()", "changedir(player,1)",
            "fadein()",

            "play(5)",         "loadscript(intro)",
        };
        filllines(lines);
        ...
        static const char* lines[] = {
            ...
            "gotoroom(2,16)",  "gotoposition(58,193,0)",
            "setcheckpoint()", "changedir(player,1)",
            "fadein()",
        ...
        static const char* lines[] = {
            ...
            "gotoroom(14,1)",  "gotoposition(45,73,0)",
            "setcheckpoint()", "changedir(player,1)",
            "fadein()",
        ...
        static const char* lines[] = {
            ...
            "gotoroom(8,9)",   "gotoposition(95,193,0)",
            "setcheckpoint()", "changedir(player,1)",
            "fadein()",
        ...
        static const char* lines[] = {
            "cutscene()",        "untilbars()",
            "face(player,red)",  "face(red,player)",

            "squeak(player)",    "text(player,0,0,1)",
            "Follow me!",        "position(player,above)",
            "speak_active",

            "squeak(red)",       "text(red,0,0,1)",
            "Aye aye, Captain!", "position(red,above)",
            "speak_active",      "endtext",
        ...
        static const char* lines[] = {
            ...
            "gotoroom(12,14)", "gotoposition(126,38,1)",
            "setcheckpoint()", "changedir(player,0)",
            "fadein()",
        ...
        static const char* lines[] = {
            ...
            "gotoroom(7,8)",   "gotoposition(145,145,0)",
            "setcheckpoint()", "changedir(player,0)",
            "fadein()",
    ...
    if (SDL_strcmp(t, "talkpurple_1") == 0) {
        ...
        static const char* lines[] = {
            ...
            "squeak(blue)",
            "changetile(blue,6)", // smiling again! blue always needs to specify
                                  // her mood
            "text(blue,0,0,1)",
        ...
        static const char* lines[] = {
            "gotoroom(19,7)",  "gotoposition(132,137,0)", "fadein()",

            "setcheckpoint()",

            "play(11)",        "endcutscene()",           "untilbars()",
        };
        filllines(lines);
    } else {
        loadother(t);
