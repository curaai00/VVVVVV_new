...
public:
    ...
    void createtextbox(std::string t,
                       int xp,
                       int yp,
                       int r = 255,
                       int g = 255,
    ...
    void drawpixeltextbox(int x,
                          ...
                          int xo,
                          int yo);
    void drawcustompixeltextbox(int x,
                                int y,
                                int w,
                                int h,
                                int w2,
    ...
    void
    drawimagecol(int t, int xp, int yp, int r, int g, int b, bool cent = false);
    ...
    void
    bprint(int x, int y, std::string t, int r, int g, int b, bool cen = false);

    void bprintalpha(int x,
                     int y,
                     std::string t,
                     int r,
                     int g,
    ...
    bool Hitest(SDL_Surface* surface1,
                point p1,
