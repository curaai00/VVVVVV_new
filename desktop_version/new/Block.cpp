...
void Block::construct(const std::array<unsigned short, SURFACE_ARR_SIZE>& room_arr,
                      const TileAsset& tile_asset)
{
    ...
    auto contain = [](const std::vector<unsigned short>& indicies,
                      unsigned short var) -> bool {
